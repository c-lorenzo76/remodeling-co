            ...
            <div className={"w-[90%] max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4"}>
                <Card className={"mx-auto w-full max-w-[400px] bg-[#EEEEEE] shadow-xl border-none"}>
                    ...
                    <CardContent>
                        ...
                        <img alt={"kitchen_img"} className={"aspect-square rounded object-cover"} src={"../src/assets/images/IMG_4145.JPG"} />
                    </CardContent>
                ...
                <Card className={"mx-auto w-full max-w-[400px] bg-[#EEEEEE] shadow-xl border-none"}>
                    ...
                    <CardContent>
                        ...
                        <img alt={"bathroom_img"} className={"aspect-square rounded object-cover"} src={"../src/assets/images/IMG_4142.JPG"}/>
                    </CardContent>
                    <CardFooter className={"flex justify-center"}>
                        <CardTitle className={"text-center font-normal text-3xl"}>
                            Bathroom remodeling
                ...
                <Card className={"mx-auto w-full max-w-[400px] bg-[#EEEEEE] shadow-xl border-none"}>
                    ...
                    <CardContent>
                        ...
                        <img alt={"living-room_img"} className={"aspect-square rounded object-cover"} src={"../src/assets/images/IMG_4149.JPG"} />
                    </CardContent>
                    <CardFooter className={"flex justify-center"}>
                        <CardTitle className={"text-center font-normal text-3xl"}>
                            Room additions
