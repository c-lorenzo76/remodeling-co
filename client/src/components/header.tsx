...
export const Header = () => {
    return (
        <header className={"bg-[#4A4947] text-[#EEEEEE] sticky top-0 z-50 font-afacad flex justify-center"}>
            <div className={"grid grid-cols-2 w-full max-w-6xl mx-2 h-9 "}>
                ...
                <div className={"flex justify-end"}>
                    <a className={"flex items-center mx-2"}>
                        ...
                        <Link to={"https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://www.facebook.com/p/Flores-and-Sons-Remodeling-100057412060941/&ved=2ahUKEwj60J-5z5GJAxUS78kDHRA9BBEQFnoECBwQAQ&usg=AOvVaw3-dy1MCBss_MdGY6wim2wV"}>
                            <FaFacebookSquare
                                className={"ml-2"}/>
                        </Link>
                    </a>
