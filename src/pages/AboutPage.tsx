        ...
        <Layout>
            <div className={"lg:w-[80%] flex flex-row items-center mx-auto h-fit bg-[#393E46]"}>
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <Link to={"/"} className={"text-[#EEEEEE] hover:text-[#EEEEEE]/60 hover:-translate-y-0.5 transform transition duration-200 text-lg"}>Home</Link>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator/>
                        <BreadcrumbItem>
                            <BreadcrumbPage className={"text-[#EEEEEE]/60 text-lg"}>About</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
            <div className={"h-fit w-[80%] mx-auto bg-[#393E46] text-[#EEEEEE] flex flex-col justify-center items-center"}>
            ...
            <div className={"h-32 bg-[#393E46] flex justify-center"}>
                hello
            </div>
        </Layout>
    )
