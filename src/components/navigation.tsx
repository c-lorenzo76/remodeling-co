...
export const Navigation = () => {
    return (
        <div className="relative isolate bg-gray-900 font-afacad">
            <AuroraBackground>
                        ...
                        <div
                            ...
                            {links.map((link) => (
                                <Link key={link.name} to={link.to} >
                                    <Button className={"bg-transparent hover:bg-transparent hover:-translate-y-1 transform transition duration-200 shadow-none"}>
