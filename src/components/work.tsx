...
export const Work = () => {
    ...
    return (
        <div className={"h-fit "}>
            <div className={"w-[80%] max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4"}>
                <Card className={"mx-auto w-full max-w-[350px] bg-[#EEEEEE]"}>
                    ...
                    <CardContent>
                        <img alt={"kitchen_img"} className={"aspect-square rounded object-cover"} src={"https://plus.unsplash.com/premium_photo-1680382578857-c331ead9ed51?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8a2l0Y2hlbiUyMGJhY2tncm91bmR8ZW58MHx8MHx8fDA%3D"} />
                    </CardContent>
                </Card>
                <Card className={"mx-auto w-full max-w-[350px] bg-[#EEEEEE]"}>
                    <CardHeader>
                ...
                <Card className={"mx-auto w-full max-w-[350px] bg-[#EEEEEE]"}>
                    ...
                    <CardContent>
                        <img alt={"living-room_img"} className={"aspect-square rounded object-cover"} src={"https://plus.unsplash.com/premium_photo-1706140675031-1e0548986ad1?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bGl2aW5ncm9vbXxlbnwwfHwwfHx8MA%3D%3D"} />
                    </CardContent>
                </Card>
                {/*<Card className={"mx-auto w-full max-w-[350px] bg-[#EEEEEE]"}>*/}
                {/*    <CardHeader>*/}
